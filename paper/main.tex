...
values, due to Ahmed, had stood since 2012. Every lower bound ships as an explicit colouring, checkable
...
Encyclopedia of Integer Sequences in 2012 \cite{oeis}. The five families
...
Second, \seq{A217236} is the only family here with $k > j$, and it is the only
one whose exhaustiveness walk makes substantial use of the unit-propagation
...
All code, certificates, proof objects and result records supporting this
