...
\emph{claimed}; for \seq{A217059} the gate was finished only after the
computation itself, which is why that value spent nearly two weeks withheld
(Sections~\ref{sec:a217005}--\ref{sec:a217059}); for \seq{A217058} the gate
